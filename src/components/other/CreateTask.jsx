        ...
        <form className='flex flex-wrap items-start justify-between w-full'>
            <div className='w-1/2'>
                <div>
                    ...
                    <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text" placeholder='Make an UI Design'/>
                </div>
                <div>
            ...
            <div className='w-2/5 flex flex-col items-start'>
                ...
                <textarea className='w-full text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400' placeholder='Enter task description' rows="6" cols="50"></textarea>
